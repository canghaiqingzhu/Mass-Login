var baiduGis2, drawingManager2, nowPolygon2, map2;
$(function() {
	baiduGis2 = function(mapId, options) {
		map2 = new BMap.Map(mapId, {
	...
	baiduGis2.prototype.baseInit = function() {
		// 初始化地图,设置中心点坐标和地图级别
		var map = this.map;
	...
	baiduGis2.prototype.bindDraw = function() {
		drawingManager2 = new BMapLib.DrawingManager(this.map, {
		...
		drawingManager2.addEventListener("overlaycomplete", function(e) {
			nowPolygon2 = e.overlay;
			nowPolygon2.enableEditing();
		});
	}
});
function openDraw() {
